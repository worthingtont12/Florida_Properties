...
census = pd.read_excel('Data/FloridaCensus2010/FL_Census2010_STCOPLCT_BasicRace.xls', sheetname=1, header=1,
...
censusDem = pd.read_csv('Data/FloridaCensus2010/DEC_10_SF1_SF1DP1_with_ann.csv',
                        header=1, low_memory=False, converters={'Id2': str})
...
censusEmp = pd.read_csv('Data/FloridaCensus2010/ACS_10_5YR_S2301_with_ann.csv',
                        header=1, low_memory=False, converters={'Id2': str})
...
censusMhi = pd.read_csv('Data/FloridaCensus2010/ACS_10_5YR_S1903_with_ann.csv',
                        header=1, low_memory=False, converters={'Id2': str})
...
censusFam = pd.read_csv('Data/FloridaCensus2010/ACS_10_5YR_S1702_with_ann.csv',
                        header=1, low_memory=False, converters={'Id2': str})
...
censusEdu = pd.read_csv('Data/FloridaCensus2010/ACS_10_5YR_S1501_with_ann.csv',
                        header=1, low_memory=False, converters={'Id2': str})
...
MHI_WGT_IA = census[
    'Median income (dollars); Estimate; One race-- - American Indian and Alaska Native'] / MHI_WGT_DENOM
MHI_WGT_IA = MHI_WGT_IA.fillna(value=0)
MHI_WGT_NA = census[
    'Median income (dollars); Estimate; One race-- - Native Hawaiian and Other Pacific Islander'] / MHI_WGT_DENOM
MHI_WGT_NA = MHI_WGT_NA.fillna(value=0)
MHI_WGT_OTHER = census[
    'Median income (dollars); Estimate; One race-- - Some other race'] / MHI_WGT_DENOM
